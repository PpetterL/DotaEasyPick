...
our %config = (
    ...
    "openssldir" => "D:/a/DotaEasyPick/DotaEasyPick",
    "options" => "enable-capieng -lcrypt32 --prefix=D:/a/DotaEasyPick/DotaEasyPick --openssldir=D:/a/DotaEasyPick/DotaEasyPick no-acvp-tests no-afalgeng no-asan no-asm no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "2",
    ...
    "perlargv" => [
        ...
        "enable-capieng",
        "-lcrypt32",
        "--prefix=D:/a/DotaEasyPick/DotaEasyPick",
        "--openssldir=D:/a/DotaEasyPick/DotaEasyPick"
    ],
    "perlenv" => {
        "AR" => undef,
...
unless (caller) {
    ...
    use lib '/d/a/DotaEasyPick/DotaEasyPick/openssl-3.0.2/util/perl';
    use OpenSSL::fallback '/d/a/DotaEasyPick/DotaEasyPick/openssl-3.0.2/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/d/a/DotaEasyPick/DotaEasyPick/openssl-3.0.2/Configurations';
        use gentemplate;
