...
unless (caller) {
    ...
    use lib '/d/Benutzer/Frederic/Documents/C_Libraries/openssl-3.0.2/util/perl';
    use OpenSSL::fallback '/d/Benutzer/Frederic/Documents/C_Libraries/openssl-3.0.2/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/d/Benutzer/Frederic/Documents/C_Libraries/openssl-3.0.2/Configurations';
        use gentemplate;
