...
BEGIN {
    ...
    require '/d/Benutzer/Frederic/Documents/C_Libraries/openssl-3.0.2/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/d/Benutzer/Frederic/Documents/C_Libraries/openssl-3.0.2/test/fips-and-base.cnf';
    shift;
