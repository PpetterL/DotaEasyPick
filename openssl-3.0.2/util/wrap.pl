...
BEGIN {
    ...
    require '/d/a/DotaEasyPick/DotaEasyPick/openssl-3.0.2/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/d/a/DotaEasyPick/DotaEasyPick/openssl-3.0.2/test/fips-and-base.cnf';
    shift;
