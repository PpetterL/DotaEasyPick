...
const char * LIB_PATH_VALUE   = "D:\\Benutzer\\Frederic\\Documents\\C_Libraries\\curl-7.82.0\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D;D:\\msys64\\msys64\\mingw32\\lib;D;D:\\msys64\\msys64\\mingw32\\bin;D:\\Benutzer\\Frederic\\Documents\\C_Libraries\\curl-7.82.0\\lib\\.libs;D:\\MinGW\\lib;D:\\MinGW\\bin;";
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.6 Debian-2.4.6-15\n");
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15\n", f);
  fputs ("#\n", f);
  ...
  fputs ("    PATH=D:/msys64/mingw32/lib:D:/msys64/mingw32/bin:/d/Benutzer/Frederic/Docum", f);
  fputs ("ents/C_Libraries/curl-7.82.0/lib/.libs:/d/MinGW/lib:/d/MinGW/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/Benutzer/Frederic/Documents/C_Libraries/curl-7.82.0/lib/.libs:$PAT", f);
  fputs ("H\"\n", f);
  fputs ("\n", f);
